...
namespace MTP1.Service
{
    ...
    /// The actor dic entity service.
    /// </summary>
    public class TechnicalFactorEntityService : BaseEntityService<TechnicalFactor>
    {
        #region Fields
        ...
        /// Gets EntitySet.
        /// </summary>
        protected override ObjectSet<TechnicalFactor> EntitySet
        {
            get
            {
                return this.entities.TechnicalFactor;
            }
        }
