...
namespace MTP1.Service
{
    ...
    /// The actor dic entity service.
    /// </summary>
    public class DictionariesEntityService : BaseEntityService<Dictionaries>
    {
        #region Fields
        ...
        /// Gets EntitySet.
        /// </summary>
        protected override ObjectSet<Dictionaries> EntitySet
        {
            get
            {
                return this.entities.Dictionaries;
            }
        }
