...
namespace MTP1.Service
{
    ...
    /// The actor dic entity service.
    /// </summary>
    public class TesMethodDicEntityService : BaseEntityService<TestMethodDic>
    {
        #region Fields
        ...
        /// Gets EntitySet.
        /// </summary>
        protected override ObjectSet<TestMethodDic> EntitySet
        {
            get
            {
                return this.entities.TestMethodDic;
            }
        }
