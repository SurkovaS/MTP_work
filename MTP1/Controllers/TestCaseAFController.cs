...
namespace MTP1.Controllers
{
    ...
    /// The actor dic controller.
    /// </summary>
    public class TestCaseAFController : BaseController<TestCaseAF>
    {
        ...
        /// The service.
        /// </param>
        public TestCaseAFController(IBaseService<TestCaseAF> service)
            : base(service)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="ActorDicController"/> class.
        /// </summary>
        public TestCaseAFController()
            : this(TestCaseAFServiceFactory.Create())
        {
        }
