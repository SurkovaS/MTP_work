...
namespace MTP1.Service
{
    ...
    /// The actor dic entity service.
    /// </summary>
    public class PrimMetrREDicEntityService : BaseEntityService<PrimMetrREDic>
    {
        #region Fields
        ...
        /// Gets EntitySet.
        /// </summary>
        protected override ObjectSet<PrimMetrREDic> EntitySet
        {
            get
            {
                return this.entities.PrimMetrREDic;
            }
        }
