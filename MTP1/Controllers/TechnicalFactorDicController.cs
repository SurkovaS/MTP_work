...
namespace MTP1.Controllers
{
    ...
    /// The actor dic controller.
    /// </summary>
    public class TechnicalFactorDicController : BaseController<TechnicalFactorDic>
    {
        ...
        /// The service.
        /// </param>
        public TechnicalFactorDicController(IBaseService<TechnicalFactorDic> service)
            : base(service)
        {
        }
        ...
        /// Initializes a new instance of the <see cref="ActorDicController"/> class.
        /// </summary>
        public TechnicalFactorDicController()
            : this(TechnicalFactorDicServiceFactory.Create())
        {
        }
        public ActionResult GetTechFactors(int page, int rows, string search, string sidx, string sord)
        {
            ...
            List<TechnicalFactorDic> techFactors = this.service.Get().ApplyPaging("Title", (page - 1) * rows, rows).ToList();
