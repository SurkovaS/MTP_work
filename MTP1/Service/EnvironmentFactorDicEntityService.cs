...
namespace MTP1.Service
{
    ...
    /// The actor dic entity service.
    /// </summary>
    public class EnvironmentFactorDicEntityService : BaseEntityService<EnvironmentFactorDic>
    {
        #region Fields
        ...
        /// Gets EntitySet.
        /// </summary>
        protected override ObjectSet<EnvironmentFactorDic> EntitySet
        {
            get
            {
                return this.entities.EnvironmentFactorDic;
            }
        }
